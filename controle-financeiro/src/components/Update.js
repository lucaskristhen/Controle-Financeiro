...
<fieldset>
            ...
            <label for="month">Month:</label><select id="month" name="month" value={this.state.month} onChange={this.handleSelectChange}>
                      ...
                      <option value="Feb" id="Feb">Fevereiro</option>
                      <option value="Mar" id="Mar">Maio</option>
                      <option value="Apr" id="Apr">Abril</option>
                      <option value="May" id="May">Maio</option>
                      <option value="Jun" id="Jun">Junho</option>
                      <option value="Jul" id="Jul">Julho</option>
                      <option value="Aug" id="Aug">Agosto</option>
                      <option value="Sep" id="Sep">Setembro</option>
                      <option value="Oct" id="Oct">Otubor</option>
                      <option value="Nov" id="Nov">Novembro</option>
                      <option value="Dec" id="Dec">Dezembro</option>
                </select>
