...
render() {
    return (
      <div>
        ...
        <table>
          <thead>
            <tr><th></th><th className='desc-col'>Descrição</th><th className='button-col'>Valor</th><th className='button-col'>Mês</th><th className='button-col'>Ano</th><th className='button-col'>Atualizar</th><th className='button-col'>Deletar</th></tr>
          </thead>
          <tbody>
            {
